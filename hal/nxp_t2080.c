...
int hal_dts_fixup(void* dts_addr)
{
    ...
    if (off >= 0) {
#ifdef ENABLE_OS64BIT
        /* For 64-bit OS: set 3-region memory layout matching CW U-Boot's
         * fdt_fixup_memory_vxworks(). Regions avoid the peripheral hole
         * at 0x7E400000-0x7FFFFFFF (reserved for CPU release/spin table).
         * Region 3 maps upper DDR via the 36-bit LAW at PA 0xC_00000000. */
