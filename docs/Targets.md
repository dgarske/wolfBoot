...
The tools are installed with STM32CubeIDE at:
```
/opt/st/stm32cubeide_<ver>/plugins/com.st.stm32cube.ide.mcu.externaltools.cubeprogrammer.*/tools/bin/
```

```sh
STM32_Programmer_CLI -c port=SWD ap=1 \
    -el ExternalLoader/OTP_FUSES_STM32N6xx.stldr \
